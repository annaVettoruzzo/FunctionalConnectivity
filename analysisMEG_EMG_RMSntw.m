...
%tasks relating graph metrics extracted from FC matrices at rest with RMS feature extracted from EMG data.
%
...
%save figure
if ntwName == "CON"
    folderName = 'D:\Tesi\Codice\EMG_analysis\ResultsEMG\RMS\NtwApproach\CONT/'; 
else
    folderName = ['D:\Tesi\Codice\EMG_analysis\ResultsEMG\RMS\NtwApproach\', ntwName, '/'];
end
