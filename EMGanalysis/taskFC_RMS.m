...
%tasks relating FC values during task with RMS feature extracted from EMG data.
%
...
%save figure
if ntwName == "CON"
    folderName = 'D:\Tesi\Codice\EMG_analysis\ResultsEMG\RMS\Task_EMG\CONT/'; 
else
    folderName = ['D:\Tesi\Codice\EMG_analysis\ResultsEMG\RMS\Task_EMG\', ntwName, '/'];
end
